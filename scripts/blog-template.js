...
${faqSchema}  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .back-btn { display:flex; width:max-content; align-items:center; gap:0.5rem; margin:2.5rem auto 0; color:var(--text-mid); font-size:0.85rem; font-weight:700; letter-spacing:0.02em; text-decoration:none; background:#fff; border:1px solid rgba(30,42,30,0.16); padding:0.65rem 1.5rem; border-radius:50px; transition:color 0.2s, border-color 0.2s, background 0.2s; }
    .back-btn:hover { background:rgba(44,74,44,0.06); border-color:rgba(44,74,44,0.35); color:var(--forest); }
